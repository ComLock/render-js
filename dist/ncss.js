...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.isArrayOrFuncOrString=isArrayOrFuncOrString;var _isFunction=__webpack_require__(12);var _isString=__webpack_require__(0);function isArrayOrFuncOrString(value){return Array.isArray(value)||(0,_isString.isString)(value)||(0,_isFunction.isFunction)(value)}
...
"use strict";
var _el=__webpack_require__(61);var _elements=__webpack_require__(10);var _isArray=__webpack_require__(3);var _isArrayOrFuncOrString=__webpack_require__(54);var _isFunction=__webpack_require__(12);var _isString=__webpack_require__(0);var _dashPropToAbbrClassName=__webpack_require__(7);var _valueDashPropToAbbrClassName=__webpack_require__(9);var _addDefaultUnit=__webpack_require__(1);var _classAppendAndCssFromMedia=__webpack_require__(50);var _classAppendAndCssFromStyle=__webpack_require__(14);var _toClassName=__webpack_require__(8);var _uniqCss=__webpack_require__(53);function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function')}}var Node=function Node(){var _ref=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{},_ref$html=_ref.html,html=_ref$html===undefined?'':_ref$html,_ref$css=_ref.css,css=_ref$css===undefined?{}:_ref$css;_classCallCheck(this,Node);this.html=html;this.css=css};exports.Node=Node;exports.el=function(tag){var spec=arguments.length>1&&arguments[1]!==undefined?arguments[1]:null;var content=arguments.length>2&&arguments[2]!==undefined?arguments[2]:null;var _ref2=arguments.length>3&&arguments[3]!==undefined?arguments[3]:{},_ref2$abbreviateCssPr=_ref2.abbreviateCssPropertyValues,abbreviateCssPropertyValues=_ref2$abbreviateCssPr===undefined?true:_ref2$abbreviateCssPr,_ref2$abbreviateCssPr2=_ref2.abbreviateCssPropertyNames,abbreviateCssPropertyNames=_ref2$abbreviateCssPr2===undefined?true:_ref2$abbreviateCssPr2,_ref2$addDefaultUnits=_ref2.addDefaultUnits,addDefaultUnits=_ref2$addDefaultUnits===undefined?true:_ref2$addDefaultUnits,_ref2$autoprefixer=_ref2.autoprefixer,autoprefixer=_ref2$autoprefixer===undefined?true:_ref2$autoprefixer;if(spec instanceof Node||(0,_isArrayOrFuncOrString.isArrayOrFuncOrString)(spec)){content=spec;spec={}}var css=[];if(spec){var options={dashPropToAbbrClassNameFn:abbreviateCssPropertyNames?_dashPropToAbbrClassName.dashPropToAbbrClassName:_toClassName.toClassName,valueDashPropToAbbrClassNameFn:abbreviateCssPropertyValues?_valueDashPropToAbbrClassName.valueDashPropToAbbrClassName:_toClassName.toClassName,addDefaultUnitFn:addDefaultUnits?_addDefaultUnit.addDefaultUnit:function(value){return value},autoprefixer:autoprefixer};if(spec.style){var s=(0,_classAppendAndCssFromStyle.classAppendAndCssFromStyle)(spec.style,options);spec.class=[].concat(spec.class,s.classAppend).filter(function(n){return n});css=(0,_uniqCss.uniqCss)(css.concat(s.css));spec.style=null}if(spec._media){var o=(0,_classAppendAndCssFromMedia.classAppendAndCssFromMedia)(spec._media,options);spec.class=[].concat(spec.class,o.classAppend).filter(function(n){return n});css=(0,_uniqCss.uniqCss)(css.concat(o.css));spec._media=null}}if(!(0,_isArray.isArray)(content)){content=[content]}content=content.map(function(item){while((0,_isFunction.isFunction)(item)){item=item()}if(item instanceof Node){css=(0,_uniqCss.uniqCss)(css.concat(item.css));return item.html}if((0,_isString.isString)(item)){return item}return''}).join('');return new Node({html:(0,_el.el)(tag,spec,content),css:css})};_elements.HTML_AND_SVG_ELEMENTS.forEach(function(k){exports[k]=function(){var _exports;for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key]}return(_exports=exports).el.apply(_exports,[k].concat(args))}});
