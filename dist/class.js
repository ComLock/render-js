...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.addContent=addContent;var _isArray=__webpack_require__(1);var _element=__webpack_require__(9);function addContent(element,content){if((0,_isArray.isArray)(element[_element.PROP_CONTENT])){element[_element.PROP_CONTENT].push(content)}else if(element[_element.PROP_CONTENT]){element[_element.PROP_CONTENT]=[element[_element.PROP_CONTENT],content]}else{element[_element.PROP_CONTENT]=content}return element}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.getAttribute=getAttribute;var _element=__webpack_require__(9);function getAttribute(element,name){return element[_element.PROP_ATTR][name]}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.getAttributes=getAttributes;var _element=__webpack_require__(9);function getAttributes(element){return element[_element.PROP_ATTR]}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.getContent=getContent;var _element=__webpack_require__(9);function getContent(element){return element[_element.PROP_CONTENT]}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.getMedia=getMedia;var _element=__webpack_require__(9);function getMedia(element){return element[_element.PROP_MEDIA]}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.getStyle=getStyle;var _element=__webpack_require__(9);function getStyle(element){return element[_element.PROP_STYLE]}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.setAttribute=setAttribute;var _element=__webpack_require__(9);function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true})}else{obj[key]=value}return obj}function setAttribute(element,name,value){if(element[_element.PROP_ATTR]){element[_element.PROP_ATTR][name]=value}else{element[_element.PROP_ATTR]=_defineProperty({},name,value)}return element}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.setAttributes=setAttributes;var _deepmerge=__webpack_require__(36);var _deepmerge2=_interopRequireDefault(_deepmerge);var _element=__webpack_require__(9);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function setAttributes(element,attributes){element[_element.PROP_ATTR]=(0,_deepmerge2.default)(element[_element.PROP_ATTR],attributes);return element}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.setContent=setContent;var _element=__webpack_require__(9);function setContent(element,content){element[_element.PROP_CONTENT]=content;return element}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.setMedia=setMedia;var _element=__webpack_require__(9);function setMedia(element,media){element[_element.PROP_MEDIA]=media;return element}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.setStyle=setStyle;var _element=__webpack_require__(9);function setStyle(element,style){element[_element.PROP_STYLE]=style;return element}
