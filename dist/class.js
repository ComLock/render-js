...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.dashPropToAbbrClassName=dashPropToAbbrClassName;var _properties=__webpack_require__(13);var _toClassName=__webpack_require__(8);function dashPropToAbbrClassName(dashProp){return _properties.CSS_PROP_TO_ABBR[dashProp]||(0,_toClassName.toClassName)(dashProp)}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.valueDashPropToAbbrClassName=valueDashPropToAbbrClassName;var _properties=__webpack_require__(13);var _toClassName=__webpack_require__(8);function valueDashPropToAbbrClassName(value,dashProp){return _properties.CSS_PROP_VALUES_TO_ABBR[dashProp]&&_properties.CSS_PROP_VALUES_TO_ABBR[dashProp][value]||(0,_toClassName.toClassName)(value)}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.isVoid=isVoid;var _elements=__webpack_require__(10);function isVoid(tag){return _elements.VOID_ELEMENTS.indexOf(tag)!==-1}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.addContent=addContent;var _isArray=__webpack_require__(3);var _element=__webpack_require__(5);function addContent(element,content){if((0,_isArray.isArray)(element[_element.PROP_CONTENT])){element[_element.PROP_CONTENT]=element[_element.PROP_CONTENT].concat(content)}else if(element[_element.PROP_CONTENT]){element[_element.PROP_CONTENT]=[element[_element.PROP_CONTENT]].concat(content)}else{element[_element.PROP_CONTENT]=content}return element}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.getAttribute=getAttribute;var _element=__webpack_require__(5);function getAttribute(element,name){return element[_element.PROP_ATTR][name]}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.getAttributes=getAttributes;var _element=__webpack_require__(5);function getAttributes(element){return element[_element.PROP_ATTR]}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.getContent=getContent;var _element=__webpack_require__(5);function getContent(element){return element[_element.PROP_CONTENT]}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.getMedia=getMedia;var _element=__webpack_require__(5);function getMedia(element){return element[_element.PROP_MEDIA]}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.getStyle=getStyle;var _element=__webpack_require__(5);function getStyle(element){return element[_element.PROP_STYLE]}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.setAttribute=setAttribute;var _element=__webpack_require__(5);function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true})}else{obj[key]=value}return obj}function setAttribute(element,name,value){if(element[_element.PROP_ATTR]){element[_element.PROP_ATTR][name]=value}else{element[_element.PROP_ATTR]=_defineProperty({},name,value)}return element}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.setAttributes=setAttributes;var _deepmerge=__webpack_require__(59);var _deepmerge2=_interopRequireDefault(_deepmerge);var _element=__webpack_require__(5);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function setAttributes(element,attributes){element[_element.PROP_ATTR]=(0,_deepmerge2.default)(element[_element.PROP_ATTR],attributes);return element}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.setContent=setContent;var _element=__webpack_require__(5);function setContent(element,content){element[_element.PROP_CONTENT]=content;return element}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.setMedia=setMedia;var _element=__webpack_require__(5);function setMedia(element,media){element[_element.PROP_MEDIA]=media;return element}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.setStyle=setStyle;var _element=__webpack_require__(5);function setStyle(element,style){element[_element.PROP_STYLE]=style;return element}
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.buildStyle=buildStyle;exports.buildMedia=buildMedia;exports.buildStyleAndMedia=buildStyleAndMedia;exports.build=build;var _element=__webpack_require__(5);var _dashPropToAbbrClassName=__webpack_require__(7);var _valueDashPropToAbbrClassName=__webpack_require__(9);var _addDefaultUnit=__webpack_require__(1);var _classAppendAndCssFromMedia=__webpack_require__(50);var _classAppendAndCssFromStyle=__webpack_require__(14);var _toClassName=__webpack_require__(8);var _isArray=__webpack_require__(3);var _isSet=__webpack_require__(4);var _isString=__webpack_require__(0);function buildStyle(item,options){if(item[_element.PROP_STYLE]){var s=(0,_classAppendAndCssFromStyle.classAppendAndCssFromStyle)(item[_element.PROP_STYLE],options);item[_element.PROP_CSS]=(0,_isArray.isArray)(item[_element.PROP_CSS])?item[_element.PROP_CSS].concat(s.css):s.css;if(!(0,_isSet.isSet)(item[_element.PROP_ATTR])){item[_element.PROP_ATTR]={}}item[_element.PROP_ATTR].class=item[_element.PROP_ATTR].class?[].concat(item[_element.PROP_ATTR].class,s.classAppend):s.classAppend;delete item[_element.PROP_STYLE]}}function buildMedia(item,options){if(item[_element.PROP_MEDIA]){var m=(0,_classAppendAndCssFromMedia.classAppendAndCssFromMedia)(item[_element.PROP_MEDIA],options);item[_element.PROP_CSS]=(0,_isArray.isArray)(item[_element.PROP_CSS])?item[_element.PROP_CSS].concat(m.css):m.css;if(!(0,_isSet.isSet)(item[_element.PROP_ATTR])){item[_element.PROP_ATTR]={}}item[_element.PROP_ATTR].class=item[_element.PROP_ATTR].class?[].concat(item[_element.PROP_ATTR].class,m.classAppend):m.classAppend;delete item[_element.PROP_MEDIA]}}function buildStyleAndMedia(item,options){buildStyle(item,options);buildMedia(item,options)}function build(dom){var _ref=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{},_ref$abbreviateCssPro=_ref.abbreviateCssPropertyValues,abbreviateCssPropertyValues=_ref$abbreviateCssPro===undefined?true:_ref$abbreviateCssPro,_ref$abbreviateCssPro2=_ref.abbreviateCssPropertyNames,abbreviateCssPropertyNames=_ref$abbreviateCssPro2===undefined?true:_ref$abbreviateCssPro2,_ref$addDefaultUnits=_ref.addDefaultUnits,addDefaultUnits=_ref$addDefaultUnits===undefined?true:_ref$addDefaultUnits;if((0,_isString.isString)(dom)){return dom}var arr=(0,_isArray.isArray)(dom)?dom:[dom];var options={dashPropToClassNameFn:abbreviateCssPropertyNames?_dashPropToAbbrClassName.dashPropToAbbrClassName:_toClassName.toClassName,valueDashPropToAbbrClassNameFn:abbreviateCssPropertyValues?_valueDashPropToAbbrClassName.valueDashPropToAbbrClassName:_toClassName.toClassName,addDefaultUnitFn:addDefaultUnits?_addDefaultUnit.addDefaultUnit:function(value){return value}};var res=arr.map(function(item){if((0,_isString.isString)(item)){return item}buildStyleAndMedia(item,options);if(item[_element.PROP_CONTENT]){build(item[_element.PROP_CONTENT],options)}return item});dom=res.length===1?res[0]:res;return dom}
...
"use strict";
var _access=__webpack_require__(79);var _addClass=__webpack_require__(63);var _addContent=__webpack_require__(64);var _addStyle=__webpack_require__(65);var _build=__webpack_require__(77);var _clone=__webpack_require__(81);var _domPath=__webpack_require__(66);var _element=__webpack_require__(5);var _getAttribute=__webpack_require__(67);var _getAttributes=__webpack_require__(68);var _getContent=__webpack_require__(69);var _getMedia=__webpack_require__(70);var _getStyle=__webpack_require__(71);var _render=__webpack_require__(82);var _setAttribute=__webpack_require__(72);var _setAttributes=__webpack_require__(73);var _setContent=__webpack_require__(74);var _setMedia=__webpack_require__(75);var _setStyle=__webpack_require__(76);var _elements=__webpack_require__(10);var _cdata=__webpack_require__(56);var _doctype=__webpack_require__(57);exports.access=_access.access;exports.addClass=_addClass.addClass;exports.addContent=_addContent.addContent;exports.addStyle=_addStyle.addStyle;exports.build=_build.build;exports.clone=_clone.clone;exports.cdata=_cdata.cdata;exports.doctype=_doctype.doctype;exports.domPath=_domPath.domPath;exports.getAttribute=_getAttribute.getAttribute;exports.getAttributes=_getAttributes.getAttributes;exports.getContent=_getContent.getContent;exports.getMedia=_getMedia.getMedia;exports.getStyle=_getStyle.getStyle;exports.render=_render.render;exports.setAttribute=_setAttribute.setAttribute;exports.setAttributes=_setAttributes.setAttributes;exports.setContent=_setContent.setContent;exports.setMedia=_setMedia.setMedia;exports.setStyle=_setStyle.setStyle;_elements.HTML_AND_SVG_ELEMENTS.forEach(function(t){exports[t]=function(){for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key]}return _element.element.apply(undefined,[t].concat(args))}});
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.cloneObj=undefined;var _deepmerge=__webpack_require__(59);var _deepmerge2=_interopRequireDefault(_deepmerge);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}var cloneObj=exports.cloneObj=function cloneObj(obj){return(0,_deepmerge2.default)({},obj)};
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.clone=undefined;var _deepmerge=__webpack_require__(59);var _deepmerge2=_interopRequireDefault(_deepmerge);var _isArray=__webpack_require__(3);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}var clone=exports.clone=function clone(obj){return(0,_deepmerge2.default)((0,_isArray.isArray)(obj)?[]:{},obj)};
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:true});exports.render=render;var _element=__webpack_require__(5);var _build=__webpack_require__(77);var _dashPropToAbbrClassName=__webpack_require__(7);var _valueDashPropToAbbrClassName=__webpack_require__(9);var _addDefaultUnit=__webpack_require__(1);var _toClassName=__webpack_require__(8);var _uniqCss=__webpack_require__(53);var _att2Str=__webpack_require__(16);var _isVoid=__webpack_require__(17);var _isArray=__webpack_require__(3);var _isString=__webpack_require__(0);function render(dom){var _ref=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{},_ref$abbreviateCssPro=_ref.abbreviateCssPropertyNames,abbreviateCssPropertyNames=_ref$abbreviateCssPro===undefined?true:_ref$abbreviateCssPro,_ref$abbreviateCssPro2=_ref.abbreviateCssPropertyValues,abbreviateCssPropertyValues=_ref$abbreviateCssPro2===undefined?true:_ref$abbreviateCssPro2,_ref$addDefaultUnits=_ref.addDefaultUnits,addDefaultUnits=_ref$addDefaultUnits===undefined?true:_ref$addDefaultUnits;if((0,_isString.isString)(dom)){return{css:[],html:dom}}var res={css:[],html:''};var arr=(0,_isArray.isArray)(dom)?dom:[dom];var options={dashPropToAbbrClassNameFn:abbreviateCssPropertyNames?_dashPropToAbbrClassName.dashPropToAbbrClassName:_toClassName.toClassName,valueDashPropToAbbrClassNameFn:abbreviateCssPropertyValues?_valueDashPropToAbbrClassName.valueDashPropToAbbrClassName:_toClassName.toClassName,addDefaultUnitFn:addDefaultUnits?_addDefaultUnit.addDefaultUnit:function(value){return value}};for(var i=0;i<arr.length;i+=1){var item=arr[i];if((0,_isString.isString)(item)){res.html+=item}else{var boolVoid=(0,_isVoid.isVoid)(item[_element.PROP_TAG]);var contentStr='';if(!boolVoid&&item[_element.PROP_CONTENT]){var c=render(item[_element.PROP_CONTENT]);res.css=res.css.concat(c.css);contentStr=c.html}(0,_build.buildStyleAndMedia)(item,options);if(item[_element.PROP_CSS]){res.css=res.css.concat(item[_element.PROP_CSS])}if(res.css){res.css=(0,_uniqCss.uniqCss)(res.css)}var attrStr=item[_element.PROP_ATTR]?(0,_att2Str.att2Str)(item[_element.PROP_ATTR],{addDefaultUnitFn:options.addDefaultUnitFn}):'';if(boolVoid){res.html+='<'+item[_element.PROP_TAG]+attrStr+'/>'}else{res.html+='<'+item[_element.PROP_TAG]+attrStr+'>'+contentStr+'</'+item[_element.PROP_TAG]+'>'}}}return res}
