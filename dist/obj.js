...
"use strict";
var _dashPropToAbbrClassName=__webpack_require__(7);var _valueDashPropToAbbrClassName=__webpack_require__(9);var _addDefaultUnit=__webpack_require__(1);var _classAppendAndCssFromMedia=__webpack_require__(50);var _classAppendAndCssFromStyle=__webpack_require__(14);var _toClassName=__webpack_require__(8);var _uniqCss=__webpack_require__(53);var _elements=__webpack_require__(10);var _att2Str=__webpack_require__(16);var _isVoid=__webpack_require__(17);var _isArray=__webpack_require__(3);var _isEmptyObject=__webpack_require__(55);var _isFunction=__webpack_require__(12);var _isObject=__webpack_require__(62);var _isSet=__webpack_require__(4);var _isString=__webpack_require__(0);function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true})}else{obj[key]=value}return obj}_elements.HTML_AND_SVG_ELEMENTS.forEach(function(t){exports[t]=function(){var _obj3;for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key]}if((0,_isString.isString)(args[0])||(0,_isArray.isArray)(args[0])||!(0,_isSet.isSet)(args[0])||args[0]._t){var _obj2;var _obj=(_obj2={},_defineProperty(_obj2,t,{c:args[0]}),_defineProperty(_obj2,'_t',t),_obj2);return _obj}var el={a:args[0]};if((0,_isSet.isSet)(args[1])){el.c=args[1]}if(el.a._s){el.s=el.a._s;delete el.a._s}if(el.a._m){el.m=el.a._m;delete el.a._m}var obj=(_obj3={},_defineProperty(_obj3,t,el),_defineProperty(_obj3,'_t',t),_obj3);return obj}});function modifyStyleAndMediaToClassAndCss(view){var _ref=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{},_ref$dashPropToAbbrCl=_ref.dashPropToAbbrClassNames,dashPropToAbbrClassNames=_ref$dashPropToAbbrCl===undefined?true:_ref$dashPropToAbbrCl,_ref$abbreviateCssPro=_ref.abbreviateCssPropertyValues,abbreviateCssPropertyValues=_ref$abbreviateCssPro===undefined?true:_ref$abbreviateCssPro,_ref$addDefaultUnits=_ref.addDefaultUnits,addDefaultUnits=_ref$addDefaultUnits===undefined?true:_ref$addDefaultUnits;if((0,_isString.isString)(view)){return view}var arr=(0,_isArray.isArray)(view)?view:[view];var options={dashPropToAbbrClassNameFn:dashPropToAbbrClassNames?_dashPropToAbbrClassName.dashPropToAbbrClassName:_toClassName.toClassName,valueDashPropToAbbrClassNameFn:abbreviateCssPropertyValues?_valueDashPropToAbbrClassName.valueDashPropToAbbrClassName:_toClassName.toClassName,addDefaultUnitFn:addDefaultUnits?_addDefaultUnit.addDefaultUnit:function(value){return value}};var ret=arr.map(function(item){if((0,_isString.isString)(item)){return item}var tag=Object.keys(item)[0];var value=item[tag];if((0,_isObject.isObject)(value)&&!(0,_isEmptyObject.isEmptyObject)(value)){if(value.s){var s=(0,_classAppendAndCssFromStyle.classAppendAndCssFromStyle)(value.s,options);item[tag].css=(0,_isArray.isArray)(item[tag].css)?item[tag].css.concat(s.css):s.css;if(!(0,_isSet.isSet)(item[tag].a)){item[tag].a={}}item[tag].a.class=item[tag].a.class?[].concat(item[tag].a.class,s.classAppend):s.classAppend;delete item[tag].s}if(value.m){var m=(0,_classAppendAndCssFromMedia.classAppendAndCssFromMedia)(value.m,options);item[tag].css=(0,_isArray.isArray)(item[tag].css)?item[tag].css.concat(m.css):m.css;if(!(0,_isSet.isSet)(item[tag].a)){item[tag].a={}}item[tag].a.class=item[tag].a.class?[].concat(item[tag].a.class,m.classAppend):m.classAppend;delete item[tag].m}if(value.c){modifyStyleAndMediaToClassAndCss(value.c,options)}}return item});return ret.length===1?ret[0]:ret}exports.modifyStyleAndMediaToClassAndCss=modifyStyleAndMediaToClassAndCss;function render(view){var _ref2=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{},_ref2$dashPropToAbbrC=_ref2.dashPropToAbbrClassNames,dashPropToAbbrClassNames=_ref2$dashPropToAbbrC===undefined?true:_ref2$dashPropToAbbrC,_ref2$abbreviateCssPr=_ref2.abbreviateCssPropertyValues,abbreviateCssPropertyValues=_ref2$abbreviateCssPr===undefined?true:_ref2$abbreviateCssPr,_ref2$addDefaultUnits=_ref2.addDefaultUnits,addDefaultUnits=_ref2$addDefaultUnits===undefined?true:_ref2$addDefaultUnits;if((0,_isString.isString)(view)){return{css:[],html:view}}var res={css:[],html:''};var arr=(0,_isArray.isArray)(view)?view:[view];var options={dashPropToAbbrClassNameFn:dashPropToAbbrClassNames?_dashPropToAbbrClassName.dashPropToAbbrClassName:function(){return null},valueDashPropToAbbrClassNameFn:abbreviateCssPropertyValues?_valueDashPropToAbbrClassName.valueDashPropToAbbrClassName:function(){return null},addDefaultUnitFn:addDefaultUnits?_addDefaultUnit.addDefaultUnit:function(value){return value}};for(var i=0;i<arr.length;i+=1){var item=arr[i];if((0,_isString.isString)(item)){res.html+=item}else{var tag=Object.keys(item)[0];var boolVoid=(0,_isVoid.isVoid)(tag);var value=item[tag];var attrStr='';var contentStr='';if((0,_isArray.isArray)(value)){throw new Error('The value of tag:'+tag+' cannot be of type array!')}else if((0,_isFunction.isFunction)(value)){throw new Error('The value of tag:'+tag+' cannot be of type function!')}else if((0,_isObject.isObject)(value)){if((0,_isEmptyObject.isEmptyObject)(value)){contentStr=''}else{if(!boolVoid&&value.c){var c=render(value.c,options);res.css=res.css.concat(c.css);contentStr=c.html}var attrs=value.a||{};if(value.css){res.css=res.css.concat(value.css)}if(value.s){var s=(0,_classAppendAndCssFromStyle.classAppendAndCssFromStyle)(value.s,options);res.css=res.css.concat(s.css);attrs.class=attrs.class?[].concat(attrs.class,s.classAppend):s.classAppend}if(value.m){var m=(0,_classAppendAndCssFromMedia.classAppendAndCssFromMedia)(value.m,options);res.css=res.css.concat(m.css);attrs.class=attrs.class?[].concat(attrs.class,m.classAppend):m.classAppend}if(res.css){res.css=(0,_uniqCss.uniqCss)(res.css)}if(attrs){attrStr=(0,_att2Str.att2Str)(attrs,{addDefaultUnitFn:options.addDefaultUnitFn})}}}else if((0,_isString.isString)(value)){contentStr=value}if(boolVoid){res.html+='<'+tag+attrStr+'/>'}else{res.html+='<'+tag+attrStr+'>'+contentStr+'</'+tag+'>'}}}return res}exports.render=render;
