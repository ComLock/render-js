...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_css_dashPropToAbbrClassName_es__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_css_valueDashPropToAbbrClassName_es__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_css_addDefaultUnit_es__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_css_classAppendAndCssFromMedia_es__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_css_classAppendAndCssFromStyle_es__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_css_toClassName_es__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_css_uniqCss_es__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_html_elements_es__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_html_att2Str_es__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__src_html_isVoid_es__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_html_cdata_es__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_html_doctype_es__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_html_doctype_es___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__src_html_doctype_es__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_util_isArray_es__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_util_isFunction_es__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_util_isSet_es__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_util_isString_es__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__src_util_toStr_es__ = __webpack_require__(11);
var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key]}}}return target};const PROPERTY_TAG='-t';exports.PROPERTY_TAG=PROPERTY_TAG;const PROPERTY_CHILDREN='-c';exports.PROPERTY_CHILDREN=PROPERTY_CHILDREN;const PROPERTY_CSS='-cs';const PROPERTY_HTML='-h';const PROPERTY_SPEC='-s';const METHODS=['constructor','add','build','getCss','render','setDown','setUp'];const UNIQUE_ELEMENTS=['html','head','body'];class Node{constructor(tag,spec,content){if(METHODS.includes(tag)){throw new Error(`Illegal tag:${tag} matches method name!`)}this.root=this;this[PROPERTY_TAG]=tag;if(UNIQUE_ELEMENTS.includes(tag)){this[tag]=this}if(Object(__WEBPACK_IMPORTED_MODULE_15__src_util_isString_es__["a" /* isString */])(spec)||spec instanceof Node||Object(__WEBPACK_IMPORTED_MODULE_12__src_util_isArray_es__["a" /* isArray */])(spec)||Object(__WEBPACK_IMPORTED_MODULE_13__src_util_isFunction_es__["a" /* isFunction */])(spec)){content=spec;spec={}}this[PROPERTY_SPEC]=spec;this[PROPERTY_CSS]=[];this[PROPERTY_CHILDREN]=[];this.add(content)}setDown(key,value,{skip=null}={}){this[key]=value;this[PROPERTY_CHILDREN].forEach(child=>{if(child instanceof Node){if(child===skip){}else{child.setDown(key,value)}}});return this}hasDescendant(node){if(this[PROPERTY_CHILDREN].includes(node)){return true}this[PROPERTY_CHILDREN].forEach(child=>{if(child instanceof Node&&child.hasDescendant(node)){return true}});return false}add(content){if(!Object(__WEBPACK_IMPORTED_MODULE_14__src_util_isSet_es__["a" /* isSet */])(content)){return this}if(!Object(__WEBPACK_IMPORTED_MODULE_12__src_util_isArray_es__["a" /* isArray */])(this[PROPERTY_CHILDREN])){this[PROPERTY_CHILDREN]=[this[PROPERTY_CHILDREN]]}const newContents=Array.isArray(content)?content:[content];const newNodes=[];newContents.forEach(newContent=>{while(Object(__WEBPACK_IMPORTED_MODULE_13__src_util_isFunction_es__["a" /* isFunction */])(newContent)){newContent=newContent()}if(Object(__WEBPACK_IMPORTED_MODULE_15__src_util_isString_es__["a" /* isString */])(newContent)){this[PROPERTY_CHILDREN].push(newContent)}else if(newContent instanceof Node){if(this.hasDescendant(newContent)){throw new Error(`The node:${newContent[PROPERTY_TAG]} already exists in the tree! Not adding to ${this[PROPERTY_TAG]}!`)}this[PROPERTY_CHILDREN].push(newContent);newContent.parent=this;newContent.setDown('root',this.root);const addedNodeTag=newContent[PROPERTY_TAG];if(this[addedNodeTag]){if(Array.isArray(this[addedNodeTag])){if(this[addedNodeTag].includes(newContent)){throw new Error(`Path property ${addedNodeTag} already contains node!`)}this[addedNodeTag].push(newContent)}else{if(this[addedNodeTag]===newContent){throw new Error(`Path property ${addedNodeTag} already references node!`)}this[addedNodeTag]=[this[addedNodeTag],newContent]}}else{this[addedNodeTag]=newContent}newNodes.push(newContent)}else if(Object(__WEBPACK_IMPORTED_MODULE_14__src_util_isSet_es__["a" /* isSet */])(newContent)){throw new Error(`Unhandeled type when adding newContent:${Object(__WEBPACK_IMPORTED_MODULE_16__src_util_toStr_es__["a" /* toStr */])(newContent)}`)}});newNodes.forEach(addedNode=>{UNIQUE_ELEMENTS.forEach(ue=>{if(this[ue]){if(!addedNode[ue]){addedNode.setDown(ue,this[ue])}}else if(addedNode[ue]){this.root.setDown(ue,addedNode[ue],{skip:addedNode})}})});return this}build({abbreviateCssPropertyNames=true,abbreviateCssPropertyValues=true,addDefaultUnits=true,autoprefixer=true}={}){const tag=this[PROPERTY_TAG];const spec=this[PROPERTY_SPEC]||{};const options={dashPropToAbbrClassNameFn:abbreviateCssPropertyNames?__WEBPACK_IMPORTED_MODULE_0__src_css_dashPropToAbbrClassName_es__["a" /* dashPropToAbbrClassName */]:__WEBPACK_IMPORTED_MODULE_5__src_css_toClassName_es__["a" /* toClassName */],valueDashPropToAbbrClassNameFn:abbreviateCssPropertyValues?__WEBPACK_IMPORTED_MODULE_1__src_css_valueDashPropToAbbrClassName_es__["a" /* valueDashPropToAbbrClassName */]:__WEBPACK_IMPORTED_MODULE_5__src_css_toClassName_es__["a" /* toClassName */],addDefaultUnitFn:addDefaultUnits?__WEBPACK_IMPORTED_MODULE_2__src_css_addDefaultUnit_es__["a" /* addDefaultUnit */]:value=>value,autoprefixer};if(spec.style){const s=Object(__WEBPACK_IMPORTED_MODULE_4__src_css_classAppendAndCssFromStyle_es__["a" /* classAppendAndCssFromStyle */])(spec.style,options);spec.class=[].concat(spec.class,s.classAppend).filter(n=>n);this[PROPERTY_CSS]=this[PROPERTY_CSS].concat(s.css);spec.style=null}if(spec._media){const o=Object(__WEBPACK_IMPORTED_MODULE_3__src_css_classAppendAndCssFromMedia_es__["a" /* classAppendAndCssFromMedia */])(spec._media,options);spec.class=[].concat(spec.class,o.classAppend).filter(n=>n);this[PROPERTY_CSS]=this[PROPERTY_CSS].concat(o.css)}const attributes=Object(__WEBPACK_IMPORTED_MODULE_8__src_html_att2Str_es__["a" /* att2Str */])(_extends({},spec,{_media:null}),options);if(Object(__WEBPACK_IMPORTED_MODULE_9__src_html_isVoid_es__["a" /* isVoid */])(tag)){this[PROPERTY_HTML]=`<${tag}${attributes}/>`;return this}const children=this[PROPERTY_CHILDREN];if(!children){this[PROPERTY_HTML]=`<${tag}${attributes}></${tag}>`;return this}if(Object(__WEBPACK_IMPORTED_MODULE_15__src_util_isString_es__["a" /* isString */])(children)){this[PROPERTY_HTML]=`<${tag}${attributes}>${children}</${tag}>`;return this}if(children instanceof Node){children.build();this[PROPERTY_HTML]=`<${tag}${attributes}>${children[PROPERTY_HTML]}</${tag}>`;this[PROPERTY_CSS]=this[PROPERTY_CSS].concat(children[PROPERTY_CSS]);return this}if(Array.isArray(children)){let innerHtml='';children.forEach(child=>{if(child instanceof Node){innerHtml+=child.build()[PROPERTY_HTML];this[PROPERTY_CSS]=this[PROPERTY_CSS].concat(child[PROPERTY_CSS])}else if(Object(__WEBPACK_IMPORTED_MODULE_15__src_util_isString_es__["a" /* isString */])(child)){innerHtml+=child}});this[PROPERTY_HTML]=`<${tag}${attributes}>${innerHtml}</${tag}>`;return this}this[PROPERTY_HTML]='';return this}getCss(){return Object(__WEBPACK_IMPORTED_MODULE_6__src_css_uniqCss_es__["a" /* uniqCss */])(this.build()[PROPERTY_CSS])}render(){return this.build()[PROPERTY_HTML]}}exports.Node=Node;class Dom extends Node{constructor(spec,content){super('',spec,content)}build(){const children=this[PROPERTY_CHILDREN];if(!children){this[PROPERTY_HTML]='';return this}if(Object(__WEBPACK_IMPORTED_MODULE_15__src_util_isString_es__["a" /* isString */])(children)){this[PROPERTY_HTML]=children;return this}if(children instanceof Node){this[PROPERTY_HTML]=children.build()[PROPERTY_HTML];this[PROPERTY_CSS]=children[PROPERTY_CSS]?children[PROPERTY_CSS]:[];return this}if(Array.isArray(children)){let innerHtml='';children.forEach(child=>{if(child instanceof Node){innerHtml+=child.build()[PROPERTY_HTML];this[PROPERTY_CSS]=this[PROPERTY_CSS].concat(child[PROPERTY_CSS])}else if(Object(__WEBPACK_IMPORTED_MODULE_15__src_util_isString_es__["a" /* isString */])(child)){innerHtml+=child}});this[PROPERTY_HTML]=innerHtml;return this}this[PROPERTY_HTML]='';return this}}exports.Dom=Dom;__WEBPACK_IMPORTED_MODULE_7__src_html_elements_es__["a" /* HTML_AND_SVG_ELEMENTS */].forEach(k=>{exports[k]=(...args)=>new Node(k,...args)});exports.cdata=(...args)=>new Dom(Object(__WEBPACK_IMPORTED_MODULE_10__src_html_cdata_es__["a" /* cdata */])(...args));exports.doctype=(...args)=>new Dom(Object(__WEBPACK_IMPORTED_MODULE_11__src_html_doctype_es__["doctype"])(...args));
