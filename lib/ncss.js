...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isFunction_es__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__html_att2Str_es__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__html_isVoid_es__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_isArray_es__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__util_isArrayOrString_es__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__util_isArrayOrFuncOrString_es__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__util_isFunction_es__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__util_toStr_es__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_html_el_es__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_html_elements_es__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_util_isArray_es__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_util_isArrayOrFuncOrString_es__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_util_isFunction_es__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_util_isString_es__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_css_dashPropToAbbrClassName_es__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_css_valueDashPropToAbbrClassName_es__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_css_addDefaultUnit_es__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__src_css_classAppendAndCssFromMedia_es__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_css_classAppendAndCssFromStyle_es__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_css_toClassName_es__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_css_uniqCss_es__ = __webpack_require__(53);
class Node{constructor({html='',css={}}={}){this.html=html;this.css=css}}exports.Node=Node;exports.el=(tag,spec=null,content=null,{abbreviateCssPropertyValues=true,abbreviateCssPropertyNames=true,addDefaultUnits=true,autoprefixer=true}={})=>{if(spec instanceof Node||Object(__WEBPACK_IMPORTED_MODULE_3__src_util_isArrayOrFuncOrString_es__["a" /* isArrayOrFuncOrString */])(spec)){content=spec;spec={}}let css=[];if(spec){const options={dashPropToAbbrClassNameFn:abbreviateCssPropertyNames?__WEBPACK_IMPORTED_MODULE_6__src_css_dashPropToAbbrClassName_es__["a" /* dashPropToAbbrClassName */]:__WEBPACK_IMPORTED_MODULE_11__src_css_toClassName_es__["a" /* toClassName */],valueDashPropToAbbrClassNameFn:abbreviateCssPropertyValues?__WEBPACK_IMPORTED_MODULE_7__src_css_valueDashPropToAbbrClassName_es__["a" /* valueDashPropToAbbrClassName */]:__WEBPACK_IMPORTED_MODULE_11__src_css_toClassName_es__["a" /* toClassName */],addDefaultUnitFn:addDefaultUnits?__WEBPACK_IMPORTED_MODULE_8__src_css_addDefaultUnit_es__["a" /* addDefaultUnit */]:value=>value,autoprefixer};if(spec.style){const s=Object(__WEBPACK_IMPORTED_MODULE_10__src_css_classAppendAndCssFromStyle_es__["a" /* classAppendAndCssFromStyle */])(spec.style,options);spec.class=[].concat(spec.class,s.classAppend).filter(n=>n);css=Object(__WEBPACK_IMPORTED_MODULE_12__src_css_uniqCss_es__["a" /* uniqCss */])(css.concat(s.css));spec.style=null}if(spec._media){const o=Object(__WEBPACK_IMPORTED_MODULE_9__src_css_classAppendAndCssFromMedia_es__["a" /* classAppendAndCssFromMedia */])(spec._media,options);spec.class=[].concat(spec.class,o.classAppend).filter(n=>n);css=Object(__WEBPACK_IMPORTED_MODULE_12__src_css_uniqCss_es__["a" /* uniqCss */])(css.concat(o.css));spec._media=null}}if(!Object(__WEBPACK_IMPORTED_MODULE_2__src_util_isArray_es__["a" /* isArray */])(content)){content=[content]}content=content.map(item=>{while(Object(__WEBPACK_IMPORTED_MODULE_4__src_util_isFunction_es__["a" /* isFunction */])(item)){item=item()}if(item instanceof Node){css=Object(__WEBPACK_IMPORTED_MODULE_12__src_css_uniqCss_es__["a" /* uniqCss */])(css.concat(item.css));return item.html}if(Object(__WEBPACK_IMPORTED_MODULE_5__src_util_isString_es__["a" /* isString */])(item)){return item}return''}).join('');return new Node({html:Object(__WEBPACK_IMPORTED_MODULE_0__src_html_el_es__["a" /* el */])(tag,spec,content),css})};__WEBPACK_IMPORTED_MODULE_1__src_html_elements_es__["a" /* HTML_AND_SVG_ELEMENTS */].forEach(k=>{exports[k]=(...args)=>exports.el(k,...args)});
